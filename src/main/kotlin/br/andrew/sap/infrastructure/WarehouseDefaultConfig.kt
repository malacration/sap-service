...
@Configuration
@Profile("!test")
class WarehouseDefaultConfig(
    bussinePlace : BussinessPlaceService,
    @Value("\${warehouse.tolerance.fail:false}") val wareHouseToleranceFail : Boolean
) {

    val logger: Logger = LoggerFactory.getLogger(WarehouseDefaultConfig::class.java)
