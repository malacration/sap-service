...
@Configuration
@Profile("!test")
@ConditionalOnProperty(value = ["fields.ord.carregamento"], havingValue = "true", matchIfMissing = false)
class CarregamentoConfiguration(val userFieldsMDService: UserFieldsMDService,
    ...
    init {
        ...
        listOf(
            ...
            FieldMd("dataCancelamento","Data Cancelamento","@ORD_CARREGAMENTO", DbType.db_Alpha),
